---
sidebar_label: Accounting Integration Workflow
---
...
Note: You will need to have write enabled API keys. Please refer to the [Write API docs](docs/Write-api.md) for more details.
...
![Accounting integration flow](/stoplight/image-4.png)
...
- Refer to the API reference documentation for full specifications and validations.
- Contact [api@puzzle.io](mailto:api@puzzle.io) for sandbox access or testing support.
